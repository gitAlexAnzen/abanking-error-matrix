 ...
 */
package mx.com.anzen.app.abanking.error.matrix.configuration;
...
public class SwaggerConfiguration {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("mx.com.anzen.app.abanking.error.matrix.controller"))
	...
	private ApiInfo metaData() {
		...
		return new ApiInfo("Abanking Error Matrix", "Get information of codes errors",
